...
var $author$project$Main$initialModel = {enterPressed: false, text: ''};
...
var $author$project$Main$EnterWasPressed = {$: 'EnterWasPressed'};
...
var $author$project$Main$orange = A3($mdgriffith$elm_ui$Element$rgb255, 198, 125, 52);
...
var $author$project$Main$createFilterButton = function (textValue) {
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 112, 112, 112)),
				$mdgriffith$elm_ui$Element$mouseOver(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$orange)
					])),
				$mdgriffith$elm_ui$Element$pointer
			]),
		$mdgriffith$elm_ui$Element$text(textValue));
};
...
var $author$project$Main$thirdColor = A4($mdgriffith$elm_ui$Element$rgba255, 0, 46, 46, 78.0);
var $author$project$Main$white = A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
var $author$project$Main$filterRow = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$thirdColor),
		...
		_List_fromArray(
			[
				$author$project$Main$createFilterButton('ALL'),
				$author$project$Main$createFilterButton('BRU'),
				$author$project$Main$createFilterButton('HAN'),
				$author$project$Main$createFilterButton('DECO'),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$color($author$project$Main$thirdColor),
						...
						]),
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('')),
						onChange: $author$project$Main$UpdateText,
...
var $author$project$Main$primaryColor = A3($mdgriffith$elm_ui$Element$rgb255, 3, 10, 17);
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			A2($mdgriffith$elm_ui$Element$paddingXY, 20, 10),
			$mdgriffith$elm_ui$Element$Background$color($author$project$Main$primaryColor),
			$mdgriffith$elm_ui$Element$Font$color($author$project$Main$white)
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$Font$bold]),
			$mdgriffith$elm_ui$Element$text('MUAC CPC')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text('TUE 02 10:20:27')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('ATM001'))
		]));
...
var $author$project$Main$inputMessageTextRow = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			_Debug_todo(
				'Main',
				{
					start: {line: 284, column: 19},
					end: {line: 284, column: 29}
				}))
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text('InputMessage Text Row'))
		]));
var $author$project$Main$messageListRow = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
					$mdgriffith$elm_ui$Element$text('Message List Row'))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
...
var $author$project$Main$selectMessagePartsRow = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text('Select Message Parts Row'))
		]));
var $author$project$Main$content = A2(
	...
	_List_fromArray(
		[$author$project$Main$messageListRow, $author$project$Main$selectMessagePartsRow, $author$project$Main$inputMessageTextRow]));
var $author$project$Main$secondaryColor = A3($mdgriffith$elm_ui$Element$rgb255, 1, 53, 51);
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Background$color($author$project$Main$secondaryColor),
					$mdgriffith$elm_ui$Element$Font$color($author$project$Main$orange),
					$mdgriffith$elm_ui$Element$Font$bold
				]),
			A2(
			...
			$mdgriffith$elm_ui$Element$text('EZY123'),
			$mdgriffith$elm_ui$Element$text('KLM456'),
			$mdgriffith$elm_ui$Element$text('AFR789')
		]));
...
var $author$project$Main$mainPageColumn = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Main$filterRow(model),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Main$mainPageColumn(model));
};
